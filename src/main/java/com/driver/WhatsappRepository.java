...
public class WhatsappRepository {
    ...
    public String createUser(String name, String mobile){
        if(userMobile.contains(mobile)){
            throw new ArithmeticException("User already exists");
        }
    ...
    public Group createGroup(List<User> users){
        ...
        Group group = new Group(new String("Group w"+this.customGroupCount),users.size());
        adminMap.put(group,users.get(0));
        groupUserMap.put(group,users);
        groupMessageMap.put(group,new ArrayList<>());
    ...
    public int sendMessage(Message message, User sender, Group group){
        if(adminMap.containsKey(group)){
            ...
            if(userfound) {
                ...
                throw new ArithmeticException("You are not allowed to send message");
            }
            throw new ArithmeticException("Group does not exist");
    }
